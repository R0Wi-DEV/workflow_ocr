...
- If the version doesn't exist yet (e.g., NC 35 not released), check against the `master` branch of the Nextcloud Server repo

Current target: Nextcloud 35 (check `appinfo/info.xml` for updates)
