OC.L10N.register(
    ...
    "Workflow OCR error" : "Erro de Workflow OCR",
    "Workflow OCR error for file {file}" : "Erro de Workflow OCR para o arquivo {file}",
    "Workflow OCR success" : "Sucesso do Workflow OCR",
    "Workflow OCR success for file {file}" : "Sucesso do Worflow OCR para o arquivo {file}",
    ...
    "Workflow OCR Backend is installed." : "Back-end Workflow OCR é instalado.",
    "Workflow OCR Backend is installed but heartbeat failed." : "Back-end Workflow OCR é instalado, mas o heartbeat falhou.",
    "OCRmyPDF CLI is not installed." : "OCRmyPDF CLI não está instalado.",
    "OCRmyPDF CLI is not working correctly. Error was: %1$s" : "A CLI do OCRmyPDF não está funcionando corretamente. O erro foi: %1$s",
    ...
    "Custom ocrMyPdf CLI arguments" : "Argumentos personalizados da CLI do ocrMyPdf"
},
