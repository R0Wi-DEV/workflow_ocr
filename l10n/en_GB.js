OC.L10N.register(
    ...
    "Workflow settings JSON value cannot be parsed: %1$s" : "Workflow settings JSON value cannot be parsed: %1$s",
    "OCR file" : "OCR file",
    ...
    "Failed to load global settings: {error}" : "Failed to load global settings: {error}",
    "Select language(s)" : "Select language(s)",
    "Failed to load installed OCR languages: {error}" : "Failed to load installed OCR languages: {error}",
