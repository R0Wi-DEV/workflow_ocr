OC.L10N.register(
    "workflow_ocr",
    {
    "Workflow OCR" : "Рабочий процесс OCR",
    "Workflow OCR error for file {file}" : "Ошибка OCR рабочего процесса для файла {file}",
    "Workflow OCR error" : "Ошибка OCR рабочего процесса",
    "Workflow settings JSON value cannot be parsed" : "Значение JSON настроек рабочего процесса не может быть обработано",
    "OCR file" : "Файл OCR",
    "OCR processing via workflow" : "OCR обработка через рабочий процесс",
    "Server side OCR processing via workflow engine" : "Серверная обработка OCR через рабочий процесс",
