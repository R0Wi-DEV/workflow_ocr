OC.L10N.register(
    ...
    "Workflow settings JSON value cannot be parsed: %1$s" : "Töövoo seadistuste JSON-väärtuse parsimine ei õnnestu: %1$s",
    ...
    "The asynchronous OCR process will send Nextcloud notifications. Use these settings to control them." : "Asünkroonne tekstituvastuse protsess võib saata Nextcloudi teavitusi. Nende seadistustega saad määratleda oma eelistusi.",
